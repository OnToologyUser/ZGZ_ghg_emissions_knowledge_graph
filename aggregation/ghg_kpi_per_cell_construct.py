...
query = open('aggregation/ghg_kpi_per_cell_construct.rq', 'r').read() # SameAs inference should be OFF
...
res_graph.serialize(destination="data/ZGZ/ghg_kpi_per_cell_construct.nt", format="nt")
