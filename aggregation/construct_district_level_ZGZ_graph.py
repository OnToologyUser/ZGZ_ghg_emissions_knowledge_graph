...
query = open('aggregation/construct_district_level_ZGZ_graph.rq', 'r').read() # SameAs inference should be OFF
...
res_graph.serialize(destination="data/ZGZ/construct_district_level_ZGZ_graph.nt", format="nt")
